export const AccessoriesLink = [
  {
    id: "pink-cap",
    title: "Tsuki Logo Embroidered Cap",
    image:
      "https://cdn.shopify.com/s/files/1/2321/0267/products/CAP_BLACK_PINK_1_360x.jpg?v=1665576057",
    ...
    description:
      "Top off your look with our twill 6 panel curved brim cap. This hat is available in three different colour blocks, all detailed with our kanji logo on front and Tsuki logo on back.",
    details: [
...

  {
    ...
    title: "Corduroy Tsuki Cap",
    image:
      "https://cdn.shopify.com/s/files/1/2321/0267/products/bhat_360x.png?v=1675454228",
    discountedPrice: "10.00",
    originalPrice: "34.00",
    productStatus: "Sold Out",
    colors: [
  ...
  },
  {
    ...
    title: "Tsuki Socks",
    image:
      "https://cdn.shopify.com/s/files/1/2321/0267/products/SOCKS_WHITE_1_360x.jpg?v=1638976238",
    ...
    description:
      "Socks with style. Available in two classic Tsuki colour combinations, with knitted logo details and contrast toes and heels.",
    details: [
      "74% cotton, 24% polyester, 3% spandex. One size.",
      "Care Instructions: Wash with like colours, dryer safe",
    ],
    recentlyViewed: [
      {
        image:
